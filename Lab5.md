...
We conudcted a simple effect test to explore the mean difference between
non-greek women and greek women and the p-value indicated the
differences were not significant. This suggests that our hypothesis is
not supported: there is no significant difference between the GPAs
between the greek women and non-greek women
...
The main effect between men and women indicated no difference, as the
p-value was greater than 0.05. We then explored the simple effects, both
of which were not significant. There was no significant difference in
GPAs between greek men and women; nor was there a significant difference
in GPAs between non-greek men and non-greek women. Therefore, our
